...
describe('ColumnsService', () => {
  ...
  it('list() effectue un GET /api/columns', async () => {
  ...
  it('create() effectue un POST /api/columns avec le nom', async () => {
    const promise = service.create('Archivé');
    const req = httpMock.expectOne('/api/columns');
  ...
  it('rename() effectue un PATCH /api/columns/:id', async () => {
    const promise = service.rename(3, 'Nouveau nom');
    const req = httpMock.expectOne('/api/columns/3');
  ...
  it('remove() effectue un DELETE /api/columns/:id', async () => {
  ...
  it('reorder() effectue un PATCH /api/columns/reorder avec orderedIds', async () => {
    const promise = service.reorder([3, 1, 2]);
    const req = httpMock.expectOne('/api/columns/reorder');
    expect(req.request.method).toBe('PATCH');
